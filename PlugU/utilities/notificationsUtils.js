...
export function getNotificationRoute(notification) {
  ...
  switch (target_type) {
    ...
    case 'comment':
      return { pathname: '/PostDetailScreen',    params: { postId:    data?.post_id, commentId: target_id } };
    case 'listing':
      return { pathname: '/ListingDetailScreen', params: { listingId: target_id } };
    case 'conversation':
      return { pathname: '/ConversationScreen',  params: { conversationId: target_id } };
    case 'profile':
