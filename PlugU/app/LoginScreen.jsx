          ...
          >
            ...
            <View style={styles.footer}>
              <Text style={styles.footerText}>
                ...
                <Text style={styles.footerLink} onPress={onSignUpClick}>
                  Sign Up
                </Text>
              </Text>
            </View>
...
const styles = StyleSheet.create({
  ...
  wave1: {
    ...
    transform: [{ scaleX: 1.2 }], // Wider wave form
  },
  wave2: {
    opacity: 0.5,
    borderTopLeftRadius: wp(40),
    borderTopRightRadius: wp(40),
    transform: [{ scaleX: 1.1 }], // Slightly narrower
  },
  wave3: {
    opacity: 1,
    borderTopLeftRadius: wp(45),
    borderTopRightRadius: wp(45),
    transform: [{ scaleX: 1.0 }], // Normal width
  },
  formContainer: {
    flex: 1,
    zIndex: 10,
